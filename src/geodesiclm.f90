...
!              dtd, damp_mode, niters, nfev, njev, naev,
...
!    of the jacobian.
!
!    h2 an input double precision specifying the steps ize for the finite difference estimates
...
!*****************************************************************
  ...
  accepted = 0
  counter = 0
	open(unit = 1, file = 'm_after_rebuild.txt')
	write(1, *) "m = ", m
	write(1, *) "n = ", n
	close(1)
